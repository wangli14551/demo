	...
	<div style="padding: 15px;">
		<div class="layui-form-item">
			<div class="layui-input-inline">
				<input id="lay_text" type="text" name="title" required
					lay-verify="required" placeholder="输入权限名" autocomplete="off"
					class="layui-input">
			</div>
		...
		<div class="layui-form-item">
			<table class="layui-table"
				lay-data="{url:'Permission/selPerm_list',id:'userlist',page:true,toolbar: '#toolbarDemo'}"
				lay-filter="test">
				<thead>
					<tr>
						<th lay-data="{type:'checkbox'}"></th>
						<th lay-data="{field:'perm_id'}">权限ID</th>
						<th lay-data="{field:'perm_code'}">权限code</th>
						<th lay-data="{field:'perm_name'}">权限名</th>
						<th lay-data="{field:'parent_id'}">父级ID</th>
					</tr>
				</thead>
			</table>
		</div>
