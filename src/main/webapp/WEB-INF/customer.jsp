		...
		<div class="layui-form-item">
			<div class="layui-input-inline">
				<input id="lay_text" type="text" name="title" required
					lay-verify="required" placeholder="输入客户名" autocomplete="off"
					class="layui-input">
			</div>
			...
			<div class="layui-btn-group">
				...
				<button id="btn_role" type="button" class="layui-btn layui-btn-md">
					<i class="layui-icon"></i>分配客户
				</button>
			</div>
		</div>
		<div class="layui-form-item">
			<table class="layui-table"
				lay-data="{url:'Customer/user_select',id:'userlist',page:true ,toolbar: '#toolbarDemo'}"
				lay-filter="test">
				<thead>
					<tr>
						<th lay-data="{type:'checkbox'}"></th>
						<th lay-data="{field:'customer_id'}">客户ID</th>
						<th lay-data="{field:'customer_name'}">客户名</th>
						<th lay-data="{field:'customer_man'}">联系人</th>
						<th lay-data="{field:'customer_tel'}">客户电话</th>
						<th lay-data="{field:'customer_email'}">客户邮箱</th>
						<th lay-data="{field:'customer_address'}">客户地址</th>
						<th lay-data="{field:'state'}">删除状态</th>
						<th lay-data="{field:'customer_public'}">公海客户</th>
						<th lay-data="{field:'customer_grade'}">客户等级</th>
						<th lay-data="{field:'create_time'}">创建时间</th>
						<th lay-data="{field:'customer_user'}">业务员</th>
					</tr>
				</thead>
			</table>
		</div>
